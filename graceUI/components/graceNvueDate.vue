<template name="graceDate">
	<view class="grace-date" :style="{top:top, left:realshow?'0px':'-2000px'}" 
...
export default {
	...
	props: {
		...
		activeBgColor : {type:String, default:"#3B68EA"},
...
.grace-d-current{background-color:#3B68EA;}
...
.grace-date-btns-text{color:#3B68EA; line-height:100rpx; font-size:30rpx; text-align:center; width:300rpx;}
