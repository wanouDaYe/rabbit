...
export default{
	props:{
		...
		loadingPointBg : {type : String,  default : '#3B68EA'},
...
.grace-page-loading-points{width:20rpx; height:20rpx; background-color:#3B68EA; border-radius:50rpx; margin:10rpx; opacity:0.5;}
...
.grace-page-fixed-top{position:fixed; top:44px; left:0px;  width:750rpx; z-index:99998;}
</style>