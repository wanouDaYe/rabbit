...
.grace-totop{width:40px; height:40px; line-height:40px; background:#FFFFFF; color:#3B68EA; position:fixed; bottom:80px; z-index:9999; right:15px; border-radius:5px; box-shadow:0px 0px 2px #EEE; text-align:center;}
</style>